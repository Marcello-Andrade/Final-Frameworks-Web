...
"[project]/bookshelf-manager/src/modules/auth/schemas.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    email: __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email(),
    password: __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string()
});
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$src$2f$modules$2f$auth$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/bookshelf-manager/src/modules/auth/schemas.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const data = __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$src$2f$modules$2f$auth$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].parse(body);
        const result = await controller.login(data.email, data.password);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$src$2f$common$2f$apiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["success"])({
            user: result.user
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__64f36d0f._.js.map