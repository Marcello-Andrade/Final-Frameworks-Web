...
function CartPage() {
    ...
    const { borrowBook } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$src$2f$context$2f$BookContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBooks"])();
    const { addLoan } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$src$2f$context$2f$LoanContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoans"])();
    ...
    function confirmLoan() {
        let success = true;
        cart.forEach((book)=>{
            const borrowed = borrowBook(book.id);
            if (borrowed) {
                addLoan(book);
            } else {
                success = false;
        ...
        if (success) {
            clearCart();
            setMessage("✅ Loan confirmed successfully!");
        } else {
            setMessage("❌ Some books are no longer available");
        }
        setTimeout(()=>{
            setMessage("");
        }, 3000);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: cart.map((book)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "   flex   items-center   gap-5   rounded-xl   bg-white   p-5   shadow   transition   hover:-translate-y-1   hover:shadow-xl   ",
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "   flex   items-center   gap-2   rounded-lg   bg-red-600   px-4   py-2   text-white   transition   hover:bg-red-700   active:scale-95   ",
                                children: [
            ...
            message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$bookshelf$2d$manager$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "   fixed   bottom-8   right-8   rounded-xl   bg-black   px-6   py-4   text-white   shadow-2xl   animate-bounce   ",
                children: message
            }, void 0, false, {
                fileName: "[project]/bookshelf-manager/src/app/cart/page.tsx",
                lineNumber: 311,
...
_s(CartPage, "tvZbd1dUgpH0tRnC22PeV76e7i8=", false, function() {
    return [
...
//# sourceMappingURL=_bd072ddc._.js.map